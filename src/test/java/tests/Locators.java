...
public class Locators {
    public static String GoogleSearchField = "//input[@title='Buscar']";
    public static String selectOption = "//div[@class='sbic vYOkbe']";
    public static String selectLink = "//h3[normalize-space()='Mercado Libre México - Envíos Gratis en el día']";
